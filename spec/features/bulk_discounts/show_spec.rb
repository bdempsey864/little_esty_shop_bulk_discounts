...
RSpec.describe 'bulk discount index' do
  ...
  it 'displays discounts quantity_threshold and percentage' do
    expect(page).to have_content((@bd1.percentage * 100).round)
    expect(page).to have_content((@bd1.quantity_threshold))
    expect(page).to_not have_content((@bd3.percentage * 100).round(2))
    expect(page).to_not have_content((@bd3.quantity_threshold))
  end
